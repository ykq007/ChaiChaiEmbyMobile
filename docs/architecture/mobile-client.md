...
- `platform:adaptive` owns window-characteristic policy without device-name detection. The activity preserves separating-fold bounds so the shell can select one unobstructed pane instead of drawing beneath a hinge.
